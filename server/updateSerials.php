<?php
	...
	//$query = "Insert into films (name, mark, action, dateTime, dateRemember, image_url, comment, image_path, is_private, user_id, note_id, is_saw_today, dateChange) values ('$name', '$mark', '$action', '$dateTime', '$dateRemember', '$image_url', '$comment', '$image_path', '$is_private', '$user_id', '$note_id', '$is_saw_today', '$dateChange')";
		...
		$query = "Update serials set name = '$name', mark = '$mark', action = '$action', dateTime = '$dateTime', dateRemember = '$dateRemember', image_url = '$image_url', comment = '$comment', image_path = '$image_path', is_private = '$is_private', user_id = '$user_id', note_id = '$note_id', is_saw_today = '$is_saw_today', dateChange = '$dateChange', season = '$season', series = '$series' where _id = '$note_id'";
