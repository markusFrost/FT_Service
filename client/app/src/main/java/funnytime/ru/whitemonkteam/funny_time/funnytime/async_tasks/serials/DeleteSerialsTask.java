 ...
 */
public class DeleteSerialsTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public DeleteSerialsTask(Activity context, ArrayList<Serial> list, OnSerialLoadListner listner)
    {
    ...
    protected JSONObject doInBackground(Void... p)
    {
       ...
       // params.add(new BasicNameValuePair(ServerConstants., item + "" ));
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.DELETE_SERIALS, "POST", params);
