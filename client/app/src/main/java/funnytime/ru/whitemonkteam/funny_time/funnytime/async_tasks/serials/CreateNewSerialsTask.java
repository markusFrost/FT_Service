 ...
 */
public class CreateNewSerialsTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public CreateNewSerialsTask(Activity context, ArrayList<Serial> list, OnSerialLoadListner listner)
    {
    ...
    protected JSONObject doInBackground(Void... p)
    {
       ...
       // params.add(new BasicNameValuePair(ServerConstants., item + "" ));
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.ADD_SERIALS, "POST", params);
