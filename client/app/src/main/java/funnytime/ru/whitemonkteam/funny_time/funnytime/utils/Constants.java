...
public class Constants {
   ...
   // public static final String NETWORK_ID = "networkId";
    ...
    public static final int TYPE_USERS = 5;
        ...
        public static final int TYPE_SHOW_USERS_FILMS = 6;
    public static final int TYPE_SHOW_USERS_SERIALS = 7;
    public static final int TYPE_SHOW_USERS_BOOKS = 8;
    ...
    public static final int CODE_ADD_USER = 16;
    ...
    public static final int CODE_SHOW_PROFILE = 17;
