 ...
 */
public class GetUserByIdTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public GetUserByIdTask(Activity context, UserDto user, OnUserLoadListner listner)
    {
    ...
    public GetUserByIdTask(Activity context, long user_id, OnUserLoadListner listner)
    {
        this.context = context;
        this.listner = listner;
    ...
    protected JSONObject doInBackground(Void... p)
    {
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.GET_USERBY_ID, "GET", params);
        return json;
    }
    ...
    protected void onPostExecute(JSONObject jsonObject)
    {
        ...
        listner.onUserLoaded(jsonObject);
        pDialog.dismiss();
    }
}
