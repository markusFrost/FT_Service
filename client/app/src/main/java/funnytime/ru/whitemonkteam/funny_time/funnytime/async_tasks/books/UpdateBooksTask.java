 ...
 */
public class UpdateBooksTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public UpdateBooksTask(Activity context, ArrayList<Book> list, OnBookLoadListner listner)
    {
    ...
    protected JSONObject doInBackground(Void... p)
    {
       ...
       // params.add(new BasicNameValuePair(ServerConstants., item + "" ));
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.UPDATE_BOOKS, "POST", params);
