 ...
 */
public class UpdateUserTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public UpdateUserTask(Activity context, UserDto user, OnUserLoadListner listner)
    {
    ...
    protected JSONObject doInBackground(Void... p)
    {
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.UPDATE_USER, "POST", params);
        return json;
    }
