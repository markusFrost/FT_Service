 ...
 */
public class UpdateFilmsTask extends AsyncTask<Void, Void, JSONObject>
{
    ...
    public UpdateFilmsTask(Activity context, ArrayList<Film> list, OnFilmLoadListner listner)
    {
    ...
    protected JSONObject doInBackground(Void... p)
    {
       ...
       // params.add(new BasicNameValuePair(ServerConstants., item + "" ));
        ...
        JSONObject json = jsonParser.makeHttpRequest(URL.MAIN_URL + URL.UPDATE_FILMS, "POST", params);
