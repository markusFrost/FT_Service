...
public class SerialAdapter extends BaseAdapter
{
	 ...
	 public SerialAdapter(Activity context)
		{
			...
			list = AppContext.dbAdapter.getSerials(ShPrefUtils.getUserId(context));
    ...
    public void Search(String name)
    {
	 ...
	 @Override
		...
		{
			// TODO Auto-generated method stub
			return AppContext.dbAdapter.getSerialById(ShPrefUtils.getUserId(context),list.get(position).Id);
		}
