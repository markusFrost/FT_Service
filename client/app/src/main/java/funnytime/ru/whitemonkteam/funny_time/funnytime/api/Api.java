...
public class Api {
    ...
    public ArrayList<User> getProfiles(Collection<Long> uids,  String fields) throws IOException, JSONException, KException{
    ...
    public ArrayList<Video> getUserById(Long user_id) throws IOException, JSONException, KException{
        Params params = new Params("video.getUserVideos");
        params.put("user_id", user_id);
        params.put("count", "50");
        JSONObject root = sendRequest(params);
