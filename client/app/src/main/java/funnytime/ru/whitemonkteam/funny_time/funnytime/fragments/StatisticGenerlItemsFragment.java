...
public class StatisticGenerlItemsFragment extends ListFragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        else if ( position == 3)
        {
          ...
          /*  for ( int i = 0; i <= 6; i++)
            {
                StatisticGeneralItem item  = list.get(i);
                if ( i == 0)
                {
                    item.Name = "Robert Salvatore";
                }
                else if ( i == 1)
                {
                    item.Name = "Robert Howard";
                }
                else if ( i == 2)
                {
                    item.Name = "Stephen King";
                }
                else if ( i == 4)
                {
                    item.Name = "James Czajkowski";
                }
                else if ( i == 5)
                {
                    item.Name = "Terry Pratchett";
                }
                else if ( i == 6)
                {
                    item.Name = "Adam Nevill";
                }
                else if ( i == 3)
                {
                    item.Name = "Dean Koontz";
                }
